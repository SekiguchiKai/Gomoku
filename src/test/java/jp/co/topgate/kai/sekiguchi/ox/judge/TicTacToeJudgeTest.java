...
public class TicTacToeJudgeTest {
    ...
    public void judgeResult() {
        this.checkRow(Moves.CIRCLE, Result.WIN);
        this.checkRow(Moves.CROSS, Result.LOSE);

        this.checkColumn(Moves.CIRCLE, Result.WIN);
        this.checkColumn(Moves.CROSS, Result.LOSE);

        this.checkLeftSlanting(Moves.CIRCLE, Result.WIN);
        this.checkLeftSlanting(Moves.CROSS, Result.LOSE);

        this.checkRightSlanting(Moves.CIRCLE, Result.WIN);
        this.checkRightSlanting(Moves.CROSS, Result.LOSE);
    }
